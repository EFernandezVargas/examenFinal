...
exports.buscaReclamo = function(req, res){
  var tipoReclamoFiltro = req.body.tipoReclamoFiltro;
  models.reclamo.findAll().then( function(reclamos){
        res.render('respuestaBusqueda',{  tipoReclamoFiltro:tipoReclamoFiltro, reclamos:reclamos});
               });
}

exports.buscarReclamo = function(req, res){
  var tipoReclamoFiltro = 'ODECO';
  models.reclamo.findAll().then( function(reclamos){
        res.render('buscarReclamo',{  tipoReclamoFiltro:tipoReclamoFiltro, reclamos:reclamos});
               });
}
